// src/components/RecipionistLogin.js
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl p-6 border border-white/20 animate-float">
            ...
            <div className="text-center mb-5">
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-3 shadow-lg shadow-blue-500/30 animate-pulse-slow">
                <FaUserShield size={24} className="text-white" />
              </div>
              <h2 className="text-xl font-bold text-white mb-1">Staff Login</h2>
              <p className="text-white/60 text-xs">Login to manage the hotel system</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <FaSignInAlt className="mr-1.5" size={14} /> Staff Login
                  </>
                )}
              </button>
            </form>
...
export default RecipionistLogin;