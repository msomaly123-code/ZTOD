// src/components/CustomerSideNavbar.js
...
const CustomerSideNavbar = ({ 
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, message: 'Your order #1234 has been confirmed', time: '2 min ago', read: false, icon: <FaCheckCircle className="text-green-500" /> },
    { id: 2, message: 'Payment of TSh 250,000 received', time: '1 hour ago', read: false, icon: <FaMoneyBillWave className="text-green-500" /> },
    { id: 3, message: 'New service available: VIP Package', time: '3 hours ago', read: true, icon: <FaConciergeBell className="text-orange-500" /> },
    { id: 4, message: 'Your order #1228 is now completed', time: '5 hours ago', read: true, icon: <FaCheckCircle className="text-purple-500" /> },
    { id: 5, message: 'Special offer: 20% off on Conference Hall', time: '1 day ago', read: true, icon: <FaStar className="text-yellow-500" /> },
  ]);

  // Menu items - Customer specific
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: <FaHome />, path: '/CustomerDashboard' },
    { id: 'orders', label: 'My Orders', icon: <FaClipboardList />, path: '/CustomerOrder' },
    { id: 'services', label: 'Book Services', icon: <FaConciergeBell />, path: '/CustomerService' },
    { id: 'payments', label: 'Payments', icon: <FaMoneyBillWave />, path: '/CustomerPayments' },
    { id: 'settings', label: 'Settings', icon: <FaCog />, path: '/CustomerSettings' },
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <Link to="/CustomerDashboard" className="flex items-center gap-2 text-xl font-bold no-underline hover:text-white">
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 truncate">{user?.email || 'customer@email.com'}</p>
            </div>
          </div>
        </div>
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-xl shadow-2xl z-50 border border-gray-100 animate-slideDown">
                      <div className="p-3 border-b border-gray-100">
                        <p className="font-semibold text-sm text-gray-800 truncate">{user?.name || 'Customer'}</p>
                        <p className="text-xs text-gray-500 truncate">{user?.email || 'customer@email.com'}</p>
                      </div>
                      <div className="p-1">
                        <Link
                          to="/CustomerSettings"
